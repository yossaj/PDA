...
describe('calculator functionality', function() {
  ...
  it('should be able to have a running totall', function () {
    running_total = element(by.css('#running_total'))
  ...
  it('should be able to display negative number', function () {
    running_total = element(by.css('#running_total'))
    element(by.css('#number1')).click();
  ...
  it('should be able to keep a running total even if clear is pressed', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number3')).click();
  ...
  it('should return NaN if divided by 0', function () {
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
    element(by.css('#operator_divide')).click();
